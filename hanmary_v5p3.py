...
def main():
    st.set_page_config(page_title="HanMARI V5.4", layout="wide")
    ...
    st.markdown("<h3 style='font-size: 26px; font-weight: bold; font-family: sans-serif;'>📊 HanMARI V5.4 : Financial Secretary</h3>", unsafe_allow_html=True)
